...
import { useCreateAgentWorkflow } from '@/hooks/react-query/agents/use-agent-workflows';
import { CreateWorkflowRequest } from '@/hooks/react-query/agents/workflow-utils';
...
// Removed step types - all steps are now simple instructions
...
export default function NewWorkflowPage() {
  ...
  }, [workflowName, workflowDescription, triggerPhrase, isDefault, steps, agentId, createWorkflowMutation, router]);
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50">
      <div className="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between">
        ...
        <Button onClick={handleSave} disabled={createWorkflowMutation.isPending} size="sm">
