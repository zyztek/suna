...
async def get_agent_workflows(
    ...
    # Get workflows with steps - RLS policies will handle access control
...
async def delete_agent_workflow(
    ...
    # Delete workflow (steps will be deleted automatically due to CASCADE)
...
async def execute_agent_workflow(
    ...
    # Get workflow with steps - RLS policies will handle access control
...
async def get_workflow_executions(
    ...
    # Get executions - RLS policies will handle access control
