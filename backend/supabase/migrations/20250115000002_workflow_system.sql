...
CREATE INDEX idx_workflow_executions_account_id ON workflow_executions(account_id);
...
CREATE INDEX idx_webhook_registrations_workflow_id ON webhook_registrations(workflow_id);
CREATE INDEX idx_webhook_registrations_path ON webhook_registrations(path);
CREATE INDEX idx_webhook_registrations_is_active ON webhook_registrations(is_active);
...
CREATE INDEX idx_workflow_execution_logs_node_id ON workflow_execution_logs(node_id);
